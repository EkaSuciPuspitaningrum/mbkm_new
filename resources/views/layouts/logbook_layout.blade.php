                    ...
                    <div class="w-full lg:w-6/12 px-4">
                        <div class="relative w-full mb-3">
                            ...
                            <input type="text" disabled
                                   ...
                                   value="{{ $mhsw_mbkm->getTanggalLog()->first()->tanggal_log }}">
                        </div>
                    </div>
                    <div class="w-full lg:w-6/12 px-4">
                        <div class="relative w-full mb-3">
                            ...
                            <input type="number" disabled
                                   class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150"
                                   value="{{ $mhsw_mbkm->getTempatLog()->first()->tempat  }}">
                        </div>
                    </div>
                    ...
                    <div class="w-full lg:w-12/12 px-4">
                        <div class="relative w-full mb-3">
                            ...
                            <textarea disabled type="text"
                                      class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150"
                                      rows="4">{{ $mhsw_mbkm->getUraianLog()->first()->uraian }}</textarea>
                        </div>
                    </div>
                    <div class="w-full lg:w-12/12 px-4">
                        <div class="relative w-full mb-3">
                            ...
                            <textarea disabled type="text"
                                      class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150"
                                      rows="4">{{ $mhsw_mbkm-> getRencanaLog()-> first()->rencana_pencapaian }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
